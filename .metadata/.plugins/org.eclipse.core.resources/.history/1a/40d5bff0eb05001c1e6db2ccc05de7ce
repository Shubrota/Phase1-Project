...
public class AdminUser {
	...
	public String[] ExecuteAdmin() {
		...
		while (cnt == 9 && utype.equals("Admin")) {
			...
			while ((!fd.isNumeric(str)) || (!(str.equals("1")) && !(str.equals("2"))&& !(str.equals("3"))&& !(str.equals("4"))&& !(str.equals("5")))) {
	...
	public boolean vKLoad() {
		...
		if (!f.exists()) {
			...
			System.out.println("*************Welcome To Vitual Key Bank !!*********************");
			System.out.println("************* This is your first login  !!*********************");
			System.out.println("");
			System.out.println("		Let's create an Administrator");
			System.out.println("		This user will have ability to create/modify/delete other users");
			System.out.println("");
			System.out.println("");
			System.out.println("  ");
			Scanner s = new Scanner(System.in);
			System.out.println("Enter an Administrator user name");
			String userName = s.nextLine();
			uname = userName;
			System.out.println("Enter  an Administrator Password");
			String password = s.nextLine();
			...
			try {
				...
				UserDtls first = new UserDtls(userName, password, "Admin");
				try {
